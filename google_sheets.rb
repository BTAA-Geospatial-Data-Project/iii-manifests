...
# Open CSV File
csv_file = CSV.read("clay.csv", headers:true, header_converters: :symbol)
...
seed = {
  ...
  "@id" => 'https://raw.githubusercontent.com/BTAA-Geospatial-Data-Project/iiif-manifests/master/manifest_9833257a-582a-4d05-93b1-1957227e615c.json',
  "@type" => "sc:Manifest",
...
# Write manifest file
File.open("manifest_9833257a-582a-4d05-93b1-1957227e615c.json","w") do |f|
